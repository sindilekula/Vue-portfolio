                  ...
                  <div class="back">
                    <div class="inner">
                      <div class="content">
                        ...
                        <p><span class="fw-bold">Description:</span>For this project I needed to create a to-do list app with it's functionality.</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="button">
                  <a target="_blank" href="https://github.com/sindilekula/To-Do-List-App">
                  <button type="button" class="btn btn-lg rounded-pill mt-5"><span><i class="fa-brands fa-github px-1"></i></span>Github</button>
                  </a>
...
export default {
    data() {
      return {
        projects: [
          {
            imgURL: "https://i.postimg.cc/ncV3CwZ5/calculator-project.png",
            title: "Calculator",
            client: "Life Choices",
          ...
          {
            imgURL: "https://i.postimg.cc/1tHZLpTb/Todo-project.png",
            title: "TODO-List App",
            client: "Life Choices",
            industry: "Web Development",
            technologies: "HTML, CSS & JAVASCRIPT",
          ...
          {
            imgURL: "https://i.postimg.cc/TYqkMgVJ/BMI-project.png",
          ...
          {
            imgURL: "https://i.postimg.cc/NG7DC89v/Temp-Convertor-project.png",
            title: "Temperature Convertor",
            client: "Life Choices",
            industry: "Web Development",
            technologies: "HTML, CSS & JAVASCRIPT",
            date: "17 June 2022",
            description: "For this project I was tasked to create a temperature convertor with its functionality",
            github: "https://github.com/sindilekula/Temperature-Convertor",
